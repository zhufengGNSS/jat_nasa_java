...
public class DE405APL {
	 ...
	 * @param jultime
	 * @throws IOException
	 * different method of reading a file that works with files read from the Internet
	 *
	 *
	 */
...
//			BufferedReader buff = new BufferedReader(file);
	 ...
	 * 
	 * Note that the DE405 ephemeris files should be in the same folder as this
	 * class.
	 * 
