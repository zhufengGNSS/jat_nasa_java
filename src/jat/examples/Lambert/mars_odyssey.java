...
public class mars_odyssey {
	...
	public void make_lambert() {
		...
		VectorN r0 = my_eph.get_planet_pos(DE405APL.EARTH, departure_time);
		VectorN v0 = my_eph.get_planet_vel(DE405APL.EARTH, departure_time);
		r0.print("r0");
		v0.print("v0");
		System.out.println("orbital velocity of earth "+v0.mag());
		VectorN rf = my_eph.get_planet_pos(DE405APL.MARS, arrival_time);
		VectorN vf = my_eph.get_planet_vel(DE405APL.MARS, arrival_time);
		rf.print("rf");
		vf.print("vf");
