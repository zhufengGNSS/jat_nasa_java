...
/**
 * <P>
 * The INSErrorState Class provides a way to initialize and handling of an INS
 * error state
 * 
 * 
 * @author
...
public class INSErrorState {
	 ...
	 *            Initial velocity vector, ECI in km/s.
	 * @param q
	 *            Initial platform to ECI quaternion.
	 * @param dr
	 *            Initial position error, RSW in m.
	 * @param dv
	 *            Initial velocity error, RSW in m/s.
	 * @param tilt
	 *            Initial tilt errors about RSW axes in arc-sec.
	 */
	 ...
	 *            Quaternion error.
	 */
	public double[] stateArray(VectorN r, VectorN v, Quaternion q, VectorN dr, VectorN dv, Quaternion dq, VectorN bg,
			VectorN ba) {
